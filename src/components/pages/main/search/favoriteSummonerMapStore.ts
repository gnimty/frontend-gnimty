...
const [FavoriteSummonerMapStoreProvider, useFavoriteSummonerMapStore] = createSSRStore(createFavoriteSummonerMapStore);

export { FavoriteSummonerMapStoreProvider, useFavoriteSummonerMapStore };
