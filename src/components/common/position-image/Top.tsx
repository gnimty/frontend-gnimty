...
export default function Top(props: PositionIconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-label="탑" {...props}>
      <path
      ...
      />
      <path fill={props.fill ?? '#a2a2a2'} d="M10.259 12.294V10.24h4.082v4.107H10.26v-2.054Z" />
    </svg>
  );
}
